...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/04 10:18:46 by abhaifou          #+#    #+#             */
/*   Updated: 2025/09/04 10:18:52 by abhaifou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		exit_error_all(t_stack *a, t_stack *b,\
			char **split, char **argv_fake);
...
int			prepare_argv(int *ac, char ***av,\
	char ***split_out, char ***argv_fake_out);
void		free_split(char **v);
void		free_all(t_stack *s);
void		cleanup_and_free(t_stack *a, t_stack *b,\
	char **split, char **argv_fake);
void		exit_error_all(t_stack *a, t_stack *b,\
	char **split, char **argv_fake);
